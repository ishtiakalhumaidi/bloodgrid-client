...
// Hardcoded user and role
const user = {
  displayName: "Ishtiak Shayaan",
  photoURL: "", // Set a URL here if needed
};

const role = "admin"; // Change to "volunteer", "admin", or "donor"
const roleIsLoading = false;
  ...
  const navLinks = (
    <>
      ...
      <div className="px-4 py-3 mb-6">
        ...
        <div className="text-xs text-secondary">{format(useCurrentDateTime(), "dd MMMM yyyy, hh:mm:ss a")}</div>
      </div>
      ...
      <div className="px-4 mb-4">
        ...
        <ul className="space-y-1">
          ...
          <DashboardNavLink
            ...
            icon={FaHeartbeat}
            location={"/dashboard/donation-requests"}
          />
          <DashboardNavLink
            title={"Search Donors"}
            icon={FaSearch}
      ...
      {role === "volunteer" && (
        <div className="px-4 mt-8">
          <h3 className="text-xs text-secondary uppercase mb-4">
            Volunteer Panel
          </h3>
          <ul className="space-y-1">
            <DashboardNavLink
      ...
      <div className="px-4 mt-8">
        ...
        <ul className="space-y-1">
          <DashboardNavLink
            title={"Edit Profile"}
            icon={FaUserEdit}
            location={"/dashboard/update-profile"}
          />
        </ul>
      </div>
    </>
      ...
      <header className="fixed top-0 left-0 right-0 bg-base-100 z-50 border-b shadow-sm">
        <div className="flex justify-between items-center px-6 py-3">
          ...
          <div className="flex items-center gap-4">
            ...
            <label
              htmlFor="my-drawer-2"
              className="drawer-button lg:hidden p-2 hover:bg-gray-100 rounded-full cursor-pointer"
            >
